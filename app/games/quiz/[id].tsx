...
export default function QuizGameScreen() {
    ...
    const handleTimeUp = () => {
        ...
        handleAnswer(currentQuestion.options[0], 0); // Just pick first as wrong for now
    };
                ...
                <View style={styles.options}>
                    {currentQuestion.options.map((option) => (
                        <OptionButton
                            ...
                            onPress={() => handleAnswer(option, 10 - timeLeft)}
                            disabled={isAnswered}
                        />
                    ))}
                </View>
...
const getStyles = () => StyleSheet.create({
    ...
    footer: {
        position: 'absolute',
        bottom: 20, // Increased from 0 to 20 (10 units up + padding)
        left: 0,
        right: 0,
        padding: 16,
        backgroundColor: colors.background,
    ...
    nextButton: {
        ...
        marginHorizontal: 20, // Added margin as requested
    },
    nextButtonText: {
