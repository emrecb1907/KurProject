...
import { SEDDE_WORDS, SEDDE_AUDIO_FILES, type Word } from '@/data/sedde';
import { useUser } from '@/store';

export default function SeddeLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === SEDDE_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = SEDDE_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('118'); // Mark Şedde as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Şedde</Text>
                    <Text style={styles.subtitle}>Şedde İşareti</Text>
                </View>
            </View>

            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.grid}>
                    {SEDDE_WORDS.map((word) => (
                        <Pressable
                            key={word.id}
                            style={({ pressed }) => [
                                styles.card,
