...
import { ALISTIRMALAR2_WORDS, ALISTIRMALAR2_AUDIO_FILES, type Word } from '@/data/alistirmalar2';
import { useUser } from '@/store';

export default function Alistirmalar2LessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === ALISTIRMALAR2_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = ALISTIRMALAR2_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('116'); // Mark Alıştırmalar-2 as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Alıştırmalar - 2</Text>
