...
export default function PeygamberlerTarihiListScreen() {
    ...
    // Use data from file
    const lessons = peygamberlerTarihi;
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTitleContainer}>
                    <Text style={styles.headerTitle}>{t('lessons.peygamberlerTarihi.groupTitle', { defaultValue: "History of Prophets" })}</Text>
                </View>
                <View style={{ width: 40 }} />
            </View>
                        ...
                        return (
                            ...
                            >
                                <View style={styles.cardContent}>
                                    {/* Icon */}
                                    <View style={[styles.iconContainer, { backgroundColor: isCompleted ? 'rgba(88, 204, 2, 0.1)' : 'rgba(153, 153, 153, 0.15)' }]}>
                                        {isCompleted ? (
