...
import { ESRE_WORDS, ESRE_AUDIO_FILES, type Word } from '@/data/esre';
...
export default function EsreLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === ESRE_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = ESRE_AUDIO_FILES[word.id];
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Esre</Text>
