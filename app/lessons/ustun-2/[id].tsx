...
import { USTUN_2_WORDS, USTUN_2_AUDIO_FILES, type Word } from '@/data/ustun2';
import { useUser } from '@/store';

export default function Ustun2LessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === USTUN_2_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = USTUN_2_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('105'); // Mark Üstün-2 as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Üstün - 2</Text>
