...
import { IKI_USTUN_WORDS, IKI_USTUN_AUDIO_FILES, type Word } from '@/data/ikiUstun';
import { useUser } from '@/store';

export default function IkiUstunLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === IKI_USTUN_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = IKI_USTUN_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('120'); // Mark İki Üstün as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>İki Üstün (Tenvin)</Text>
