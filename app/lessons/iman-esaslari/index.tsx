...
export default function ImanEsaslariListScreen() {
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTitleContainer}>
                    <Text style={styles.headerTitle}>{t('lessons.imanEsaslari.groupTitle', { defaultValue: "Articles of Faith" })}</Text>
                </View>
                <View style={{ width: 40 }} />
            </View>
                        ...
                        return (
                            ...
                            >
                                <View style={styles.cardContent}>
                                    {/* Icon */}
                                    <View style={[styles.iconContainer, { backgroundColor: isCompleted ? 'rgba(88, 204, 2, 0.1)' : 'rgba(255, 84, 84, 0.15)' }]}>
                                        {isCompleted ? (
