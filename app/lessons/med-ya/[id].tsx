...
import { MED_UZATMA_YA_WORDS, MED_UZATMA_YA_AUDIO_FILES, type Word } from '@/data/medUzatmaYa';
...
export default function MedUzatmaYaLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === MED_UZATMA_YA_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = MED_UZATMA_YA_AUDIO_FILES[word.id];
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Med (Uzatma) Harfi: Yâ</Text>
                    <Text style={styles.subtitle}>Yâ ile uzatma çalışmaları</Text>
                </View>
            </View>

            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.grid}>
                    {MED_UZATMA_YA_WORDS.map((word) => (
                        <Pressable
                            key={word.id}
                            style={({ pressed }) => [
                                styles.card,
