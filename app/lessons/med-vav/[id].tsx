...
import { MED_UZATMA_VAV_WORDS, MED_UZATMA_VAV_AUDIO_FILES, type Word } from '@/data/medUzatmaVav';
...
export default function MedUzatmaVavLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === MED_UZATMA_VAV_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = MED_UZATMA_VAV_AUDIO_FILES[word.id];
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Med (Uzatma) Harfi: Vâv</Text>
                    <Text style={styles.subtitle}>Vav ile uzatma çalışmaları</Text>
                </View>
            </View>

            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.grid}>
                    {MED_UZATMA_VAV_WORDS.map((word) => (
                        <Pressable
                            key={word.id}
                            style={({ pressed }) => [
                                styles.card,
