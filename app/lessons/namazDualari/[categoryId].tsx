...
export default function NamazDualariCategoryScreen() {
    ...
    const { lessons, titleId } = useMemo(() => {
        switch (categoryId) {
            case 'temel-dualar':
                return { lessons: namazTemelDualar, titleId: '2001' };
            case 'kisa-sureler':
                return { lessons: namazKisaSureler, titleId: '2002' };
            case 'ileri-duzey':
                return { lessons: namazIleriDuzey, titleId: '2003' };
            case 'ezber-pekistirme':
                return { lessons: namazEzberPekistirme, titleId: '2004' };
            default:
                return { lessons: [], titleId: '' };
        }
    }, [categoryId]);
        ...
        return (
            <SafeAreaView style={styles.container} edges={['top']}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <Text style={{ color: colors.textPrimary }}>Category not found: {categoryId}</Text>
                </View>
            </SafeAreaView>
        );
    }
    ...
    return (
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.header}>
                <Pressable
                    style={[styles.backButton, categoryId === 'temel-dualar' && { transform: [{ translateY: 0 }] }]}
                    onPress={() => {
                ...
                <View style={styles.headerTitleContainer}>
                    <Text style={styles.headerTitle} numberOfLines={2} adjustsFontSizeToFit>
                        {t(`lessons.namazDualari.${titleId}.title`, { defaultValue: 'Namaz Duaları' })}
                    </Text>
                </View>
                <View style={{ width: 30 }} />
            </View>
            ...
            <ScrollView
                style={[styles.content, categoryId === 'temel-dualar' && { transform: [{ translateY: 0 }] }]}
