...
import { ALISTIRMALAR1_WORDS, ALISTIRMALAR1_AUDIO_FILES, type Word } from '@/data/alistirmalar1';
import { useUser } from '@/store';

export default function Alistirmalar1LessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === ALISTIRMALAR1_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = ALISTIRMALAR1_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('111'); // Mark Alıştırmalar-1 as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Alıştırmalar - 1</Text>
                    <Text style={styles.subtitle}>Temel okuma alıştırmaları</Text>
                </View>
            </View>

            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.grid}>
                    {ALISTIRMALAR1_WORDS.map((word) => (
                        <Pressable
                            key={word.id}
                            style={({ pressed }) => [
                                styles.card,
