...
import { CEKER_WORDS, CEKER_AUDIO_FILES, type Word } from '@/data/ceker';
import { useUser } from '@/store';

export default function CekerLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === CEKER_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = CEKER_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('123'); // Mark Çeker as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Çeker (Asar)</Text>
