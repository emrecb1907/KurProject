...
import { CEZMLI_OKUNUS_WORDS, CEZMLI_OKUNUS_AUDIO_FILES, type Word } from '@/data/cezmliOkunus';
import { useUser } from '@/store';

export default function CezmliOkunusLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === CEZMLI_OKUNUS_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = CEZMLI_OKUNUS_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('109'); // Mark Harflerin Cezmli Okunuşu as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Harflerin Cezmli Okunuşu</Text>
                    <Text style={styles.subtitle}>Cezm ile okuma teknikleri</Text>
                </View>
            </View>

            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.grid}>
                    {CEZMLI_OKUNUS_WORDS.map((word) => (
                        <Pressable
                            key={word.id}
                            style={({ pressed }) => [
                                styles.card,
