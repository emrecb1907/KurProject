...
import { OTRE_WORDS, OTRE_AUDIO_FILES, type Word } from '@/data/otre';
import { useUser } from '@/store';

export default function OtreLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === OTRE_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = OTRE_AUDIO_FILES[word.id];
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Ötre</Text>
