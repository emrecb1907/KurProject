...
import { HARFLERIN_UZATILARAK_OKUNUSU_WORDS, HARFLERIN_UZATILARAK_OKUNUSU_AUDIO_FILES, type Word } from '@/data/harflerinUzatilarakOkunusu';
import { useUser } from '@/store';

export default function HarflerinUzatilarakOkunusuLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === HARFLERIN_UZATILARAK_OKUNUSU_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = HARFLERIN_UZATILARAK_OKUNUSU_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('112'); // Mark Harflerin Uzatılarak Okunuşu as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Harflerin Uzatılarak Okunuşu</Text>
                    <Text style={styles.subtitle}>Harflerin uzatılarak okunuşu çalışması</Text>
                </View>
            </View>

            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.grid}>
                    {HARFLERIN_UZATILARAK_OKUNUSU_WORDS.map((word) => (
                        <Pressable
                            key={word.id}
                            style={({ pressed }) => [
                                styles.card,
