...
export default function NamazBilgisiListScreen() {
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTitleContainer}>
                    <Text style={styles.headerTitle}>{t('lessons.namazBilgisi.groupTitle', { defaultValue: 'Namaz Bilgisi' })}</Text>
                </View>
...
const getStyles = (activeTheme: 'light' | 'dark') => StyleSheet.create({
    ...
    backButton: {
        ...
        borderRadius: 24,
        backgroundColor: colors.primary, // Changed to match global style
