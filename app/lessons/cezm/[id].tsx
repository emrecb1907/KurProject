...
import { CEZM_WORDS, CEZM_AUDIO_FILES, type Word } from '@/data/cezm';
import { useUser } from '@/store';

export default function CezmLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === CEZM_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = CEZM_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('110'); // Mark Cezm as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Cezm</Text>
                    <Text style={styles.subtitle}>Cezm işareti ve kullanımı</Text>
                </View>
            </View>
