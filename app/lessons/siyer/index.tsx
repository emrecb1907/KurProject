...
export default function SiyerListScreen() {
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTitleContainer}>
                    <Text style={styles.headerTitle}>{t('lessons.siyer.groupTitle', { defaultValue: "Life of Prophet Muhammad (Sirah)" })}</Text>
                </View>
                <View style={{ width: 40 }} />
            </View>
                        ...
                        return (
                            ...
                            >
                                <View style={styles.cardContent}>
                                    {/* Icon */}
                                    <View style={[styles.iconContainer, { backgroundColor: isCompleted ? 'rgba(88, 204, 2, 0.1)' : 'rgba(195, 185, 255, 0.15)' }]}>
                                        {isCompleted ? (
