...
export default function AbdestVeTemizlikListScreen() {
    ...
    // Use data from file
    const lessons = abdestVeTemizlik;
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTitleContainer}>
                    <Text style={styles.headerTitle}>{t('lessons.abdestVeTemizlik.groupTitle', { defaultValue: 'Abdest ve Temizlik' })}</Text>
                </View>
                <View style={{ width: 40 }} />
            </View>
            ...
            >
                ...
                <View style={styles.sectionHeader}>
                    <Text style={styles.sectionTitle}>{t('lessons.sectionTitle', { defaultValue: 'Dersler' })}</Text>
                </View>
                        ...
                        return (
                            ...
                            >
                                <View style={styles.cardContent}>
                                    {/* Icon */}
                                    <View style={[styles.iconContainer, { backgroundColor: isCompleted ? 'rgba(88, 204, 2, 0.1)' : 'rgba(33, 150, 243, 0.1)' }]}>
                                        {isCompleted ? (
...
const getStyles = (activeTheme: 'light' | 'dark') => StyleSheet.create({
    ...
    headerTitleContainer: {
        flex: 1,
        alignItems: 'center',
        paddingHorizontal: 24, // Added padding to increase distance from button
    },
    headerTitle: {
        fontSize: 20,
        fontWeight: 'bold',
