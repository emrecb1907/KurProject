...
import { VAV_VE_YA_SEKLI_ELIF_WORDS, VAV_VE_YA_SEKLI_ELIF_AUDIO_FILES, type Word } from '@/data/vavVeYaSekliElif';
import { useUser } from '@/store';

export default function VavVeYaSekliElifLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === VAV_VE_YA_SEKLI_ELIF_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = VAV_VE_YA_SEKLI_ELIF_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('124'); // Mark Vav ve Ya Şeklinde Yazılan Elif as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Vav ve Ya Şeklinde Yazılan Elif</Text>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.grid}>
                    {VAV_VE_YA_SEKLI_ELIF_WORDS.map((word) => (
                        <Pressable
                            key={word.id}
                            style={({ pressed }) => [
                                styles.card,
