...
import { ALISTIRMALAR3_WORDS, ALISTIRMALAR3_AUDIO_FILES, type Word } from '@/data/alistirmalar3';
import { useUser } from '@/store';

export default function Alistirmalar3LessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === ALISTIRMALAR3_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = ALISTIRMALAR3_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('119'); // Mark Alıştırmalar-3 as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Alıştırmalar - 3</Text>
