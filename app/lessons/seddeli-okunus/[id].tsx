...
import { SEDDELI_OKUNUS_WORDS, SEDDELI_OKUNUS_AUDIO_FILES, type Word } from '@/data/seddeliOkunus';
import { useUser } from '@/store';

export default function SeddeliOkunusLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === SEDDELI_OKUNUS_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = SEDDELI_OKUNUS_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('117'); // Mark Harflerin Şeddeli Okunuşu as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Harflerin Şeddeli Okunuşu</Text>
