...
import { USTUN_3_WORDS, USTUN_3_AUDIO_FILES, type Word } from '@/data/ustun3';
import { useUser } from '@/store';

export default function Ustun3LessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === USTUN_3_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = USTUN_3_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('106'); // Mark Üstün-3 as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Üstün - 3</Text>
