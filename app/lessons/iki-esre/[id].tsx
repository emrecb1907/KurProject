...
import { IKI_ESRE_WORDS, IKI_ESRE_AUDIO_FILES, type Word } from '@/data/ikiEsre';
import { useUser } from '@/store';

export default function IkiEsreLessonScreen() {
    ...
    const allItemsPlayed = playedItems.size === IKI_ESRE_WORDS.length;
    ...
    const handlePress = async (word: Word) => {
        ...
        try {
            ...
            const audioPath = IKI_ESRE_AUDIO_FILES[word.id];
    ...
    const handleCompleteLesson = () => {
        ...
        completeLesson('121'); // Mark İki Esre as completed
        router.push('/(tabs)');
    };
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>İki Esre (Tenvin)</Text>
