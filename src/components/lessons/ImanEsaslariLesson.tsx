...
export interface ImanEsaslariLessonContent {
    id: number;
...
interface ImanEsaslariLessonProps {
    lesson: ImanEsaslariLessonContent;
    lessonId: string;
}

export default function ImanEsaslariLesson({ lesson, lessonId }: ImanEsaslariLessonProps) {
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>{t('lessons.imanEsaslari.title', 'İman Esasları')}</Text>
            ...
            >
                <View style={styles.bookContainer}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                        <Sparkle size={32} color={colors.lightred} weight="fill" />
                    </View>
