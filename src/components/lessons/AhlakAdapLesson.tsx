...
export interface AhlakAdapLessonContent {
    id: number;
...
interface AhlakAdapLessonProps {
    lesson: AhlakAdapLessonContent;
    lessonId: string;
}

export default function AhlakAdapLesson({ lesson, lessonId }: AhlakAdapLessonProps) {
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>{t('lessons.ahlakAdap.title', 'Morals & Manners')}</Text>
            ...
            >
                <View style={styles.bookContainer}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                        <Heart size={32} color={colors.deepblue} weight="fill" />
                    </View>
