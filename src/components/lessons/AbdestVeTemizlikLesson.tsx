...
export interface AbdestVeTemizlikLessonContent {
    id: number;
...
interface AbdestVeTemizlikLessonProps {
    lesson: AbdestVeTemizlikLessonContent;
    lessonId: string;
}

export default function AbdestVeTemizlikLesson({ lesson, lessonId }: AbdestVeTemizlikLessonProps) {
    ...
    const styles = useMemo(() => StyleSheet.create({
        ...
        titleContainer: {
            flex: 1,
            marginLeft: 24, // Increased spacing
        },
        title: {
            fontSize: 20,
        ...
        summarySection: {
            ...
            marginTop: 8,
            borderLeftWidth: 4,
            borderLeftColor: colors.secondary, // Using secondary (blue) for Abdest/Cleanliness
        },
        summaryTitle: {
            fontSize: 20,
            fontWeight: 'bold',
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>{t('lessons.abdestVeTemizlikUI.title', 'Abdest ve Temizlik')}</Text>
            ...
            >
                <View style={styles.bookContainer}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                        <Drop size={32} color={colors.secondary} weight="fill" />
                    </View>
                ...
                <PrimaryButton
                    title={t('lessons.common.completeLesson', 'Dersi Tamamla')}
