...
export interface NamazBilgisiLessonContent {
    id: number;
...
interface NamazBilgisiLessonProps {
    lesson: NamazBilgisiLessonContent;
    lessonId: string;
}

export default function NamazBilgisiLesson({ lesson, lessonId }: NamazBilgisiLessonProps) {
    ...
    const styles = useMemo(() => StyleSheet.create({
        ...
        summarySection: {
            backgroundColor: colors.backgroundLighter || '#f8f9fa', // Fallback if undefined
            borderRadius: 12,
            padding: 20,
            marginTop: 8,
            borderLeftWidth: 4,
            borderLeftColor: colors.success, // Use success color for Namaz Bilgisi
        },
        summaryTitle: {
            fontSize: 20,
            fontWeight: 'bold',
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>{t('lessons.namazBilgisiUI.title', 'Namaz Bilgisi')}</Text>
            ...
            >
                <View style={styles.bookContainer}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                        <HandPalm size={32} color={colors.success} weight="fill" />
                    </View>
                ...
                <PrimaryButton
                    title={t('lessons.namazBilgisiUI.completeLesson', 'Dersi Tamamla')}
