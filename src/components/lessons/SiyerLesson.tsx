...
export interface SiyerLessonContent {
    id: number;
...
interface SiyerLessonProps {
    lesson: SiyerLessonContent;
    lessonId: string;
}

export default function SiyerLesson({ lesson, lessonId }: SiyerLessonProps) {
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>{t('lessons.siyer.title', 'Siyer')}</Text>
            ...
            >
                <View style={styles.bookContainer}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                        <Moon size={32} color={colors.softpurple} weight="fill" />
                    </View>
