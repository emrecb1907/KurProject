...
export interface OrucBilgisiLessonContent {
    id: number;
...
interface OrucBilgisiLessonProps {
    lesson: OrucBilgisiLessonContent;
    lessonId: string;
}

export default function OrucBilgisiLesson({ lesson, lessonId }: OrucBilgisiLessonProps) {
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>{t('lessons.orucBilgisi.title', 'Fasting Knowledge')}</Text>
            ...
            >
                <View style={styles.bookContainer}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                        <Sun size={32} color={colors.caramel} weight="fill" />
                    </View>
